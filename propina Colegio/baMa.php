...
<head>
    ...
    <title>Balanço Matrículas</title>
	...
	?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Balanço Matrículas</h1>
                        </div>
                </div>
                <div class="row">
                <div class="col-md-12">
              ...
              <div class="panel-body">
                  <form role="form" method="POST" action="baMa.php">
...
//femenino
$genero1="Femenino";
$co="SELECT SUM(valor) FROM matricula where ano=:ano and genero=:genero";
$exe=$con2->prepare($co);
$exe->bindParam(":ano",$ano,PDO::PARAM_STR);
