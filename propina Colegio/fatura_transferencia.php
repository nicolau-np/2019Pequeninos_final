...
$estado="on";
    ...
    $com="select *from tbl_transferencia where id_aluno=:id and modo=:modo and hora=:hora and data=:data";
    ...
    if($cont>0){
        ...
        $com2="insert into tbl_transferencia (id_aluno,modo,hora,data,mes,ano,valor_pago,cliente,usuario,n_fatura,estado, epoca) values(:id,:modo,:hora,:data,:mes_pagamento,:ano_lectivo,:valor_pago,:cliente,:usuario,:n_fatura,:estado, :epoca)";
    ...
    $ru2->bindParam(":epoca",$epoca,PDO::PARAM_STR);
    $ru2->execute();  
...
<tr>
<td colspan='2' id='pi'><b>PAGAMENTO DE TRANSFERENCIA</b></td>
</tr>
<tr>
...
<th class='cvb'>Valor Pago</th>
    ...
    $com="select *from tbl_transferencia where id_aluno=:ida and ano=:an and hora=:hora";
...
$se2="SELECT SUM(valor_pago) FROM tbl_transferencia where id_aluno=:id and ano=:ano and data=:data and hora=:hora";
