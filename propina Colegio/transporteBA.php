...
<head>
    ...
    <title>Balanço de Transporte</title>
	...
	?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Balanço de Transporte</h1>
                        </div>
                </div>
                <div class="row">
                <div class="col-md-12">
              ...
              <div class="panel-body">
                  <form role="form" method="POST" action="transporteBA.php">
...
echo '<br/><br/>';     
//pagamentos propina
$co="SELECT SUM(valor_pago) FROM view_pagamento_transporte where ano_lectivo=:ano and mes_pagamento=:mes";
$exe=$con2->prepare($co);
...
//femenino
$genero1="Femenino";
$co="SELECT SUM(valor_pago) FROM view_pagamento_transporte where ano_lectivo=:ano and genero=:genero and mes_pagamento=:mes";
$exe=$con2->prepare($co);
$exe->bindParam(":ano",$ano,PDO::PARAM_STR);
