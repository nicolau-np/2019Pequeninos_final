...
<br />
<div class="a"><b>Certificados Emitidos</b></div>
<form name="fom4" method="POST" class="form-inline" action="desfaz_pagamento6.php">
...
$co4="select *from tbl_pagamento_certificados where id_aluno=:id and ano_lectivo=:an order by id_pagamento_certificado desc";
...
<div class="meses_pagos">
	...
	<option value="<?php echo $rt->id_pagamento_certificado;?>"><?php echo $rt->modo."=> ".$rt->data_pagamento;?></option><?php }}?>
</select>
</div>
<br />
<br />
