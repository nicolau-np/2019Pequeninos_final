...
<br />
<div class="a"><b>Meses Pagos</b></div>
<form name="fom4" method="POST" class="form-inline" action="desfaz_pagamento7.php">
...
$co4="select *from tb_pagamento_transporte where id_aluno=:id and ano_lectivo=:an order by numero_mes asc";
...
<div class="meses_pagos">
	...
	<option value="<?php echo $rt->id_transporte;?>"><?php echo $rt->mes_pagamento;?></option><?php }}?>
</select>
</div>
<br />
<br />
