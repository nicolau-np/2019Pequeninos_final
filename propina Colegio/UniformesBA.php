...
<head>
    ...
    <title>Balanço de Uniformes</title>
	...
	?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Balanço de Uniformes</h1>
                        </div>
                </div>
                <div class="row">
                <div class="col-md-12">
              ...
              <div class="panel-body">
                  <form role="form" method="POST" action="UniformesBA.php">
...
//femenino
$genero1="Femenino";
$co="SELECT SUM(preco) FROM venderproduto where ano=:ano and genrro=:genero";
$exe=$con2->prepare($co);
$exe->bindParam(":ano",$ano,PDO::PARAM_STR);
