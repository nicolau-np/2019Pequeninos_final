...
$estado="on";
    ...
    $com="select *from tbl_pagamento_certificados where id_aluno=:id and modo=:modo and hora=:hora and data_pagamento=:data";
    ...
    if($cont>0){
        ...
        $com2="insert into tbl_pagamento_certificados (id_aluno,modo,hora,data_pagamento,mes_pagamento,ano_lectivo,valor_pago,cliente,usuario,n_fatura,estado) values(:id,:modo,:hora,:data,:mes_pagamento,:ano_lectivo,:valor_pago,:cliente,:usuario,:n_fatura,:estado)";
    ...
    $ru2->bindParam(":valor_pago",$preco,PDO::PARAM_STR);
...
<tr>
<td colspan='2' id='pi'><b>PAGAMENTO DE CERTIFICADO</b></td>
</tr>
<tr>
...
<th class='cvb'>Valor Pago</th>
    ...
    $com="select *from tbl_pagamento_certificados where id_aluno=:ida and ano_lectivo=:an and hora=:hora";
...
$se2="SELECT SUM(valor_pago) FROM tbl_pagamento_certificados where id_aluno=:id and ano_lectivo=:ano and data_pagamento=:data and hora=:hora";
