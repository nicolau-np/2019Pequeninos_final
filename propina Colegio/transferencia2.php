...
<br />
<div class="a"><b>Tranferencia Emitida</b></div>
<form name="fom4" method="POST" class="form-inline" action="desfaz_pagamento4.php">
...
$co4="select *from tbl_transferencia where id_aluno=:id and ano=:an order by id_transferencia desc";
...
<div class="meses_pagos">
	...
	<option value="<?php echo $rt->id_transferencia;?>"><?php echo $rt->modo."=> ".$rt->data;?></option><?php }}?>
</select>
</div>
<br />
<br />
