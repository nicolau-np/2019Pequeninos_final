...
<form name="fom4" method="POST" class="form-inline" action="desfaz_pagamento10.php">
...
$co4="select *from tbl_pagamento_estagio where id_aluno=:id and anolectivo=:an order by idPagaEsta asc";
...
<div class="meses_pagos">
	...
	<option value="<?php echo $rt->idPagaEsta;?>"><?php echo $rt->dataPagamento;?></option><?php }}?>
</select>
</div>
<br />
<br />
