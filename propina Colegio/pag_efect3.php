...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pagamento da Comparticipação</title>
...
?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagamento da Comparticipação</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
...
<?php } ?>
                                        ...
                                        <input type="submit" value="Entrar" class="btn btn-primary" id="bt1" name="bt1"/>
                                        <input type="submit" class="btn btn-warning" value="Listar Pais" id="bt2" name="bt2"/>
                                        <br/>
...
if (addslashes(htmlspecialchars(isset($_POST['bt1'])))):
    header("location:p35.php?curso=".$_POST['curso']."&classe=".$_POST['classe']."&turma=".$_POST['turma']
            ."&turno=".$_POST['turno']."&anoS=".$_POST['anoS']);
endif;

if(addslashes(htmlspecialchars(isset($_POST['bt2'])))):
    header("location:listar_pais.php?curso=".$_POST['curso']."&classe=".$_POST['classe']."&turma=".$_POST['turma']
            ."&turno=".$_POST['turno']."&anoS=".$_POST['anoS']);
endif;
