...
<head>
    ...
    <title>Balanço de Provas/Exames</title>
	...
	?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Balanço de Provas/Exames</h1>
                        </div>
                </div>
                <div class="row">
                <div class="col-md-12">
              ...
              <div class="panel-body">
                  <form role="form" method="POST" action="provaExameBA.php">
              ...
              if(isset($_POST['bt1'])){
                  ...
                  //pagamentos normais
                  echo '<br/><br/>';
$co="SELECT SUM(valor_pago) FROM view_pagamento_prova where ano_lectivo=:ano";
$exe=$con2->prepare($co);
...
//femenino
$genero1="Femenino";
$co="SELECT SUM(valor_pago) FROM view_pagamento_prova where ano_lectivo=:ano and genero=:genero";
$exe=$con2->prepare($co);
$exe->bindParam(":ano",$ano,PDO::PARAM_STR);
