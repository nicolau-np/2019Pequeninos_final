...
<form name="fom4" method="POST" class="form-inline" action="desfaz_pagamento8.php">
...
$co4="select *from venderproduto where pessoa_id=:id";

   $result=$con2->prepare($co4);
   $result->bindParam(":id",$verV6->id_pessoa,PDO::PARAM_STR);
...
<div class="meses_pagos">
	...
	<option value="<?php echo $rt->idProd;?>"><?php echo $rt->produto;?></option><?php }}?>
</select>
</div>
<br />
<br />
