...
<br />
<div class="a"><b>Declarações Emitidas</b></div>
<form name="fom4" method="POST" class="form-inline" action="desfaz_pagamento3.php">
<input type="hidden" id="id" value="<?php echo $processo;?>"/>
<select multiple="multiple" size="5" id="ves" class="form-control" name="ves">
<?php 


$co4="select *from tbl_pagamento_declaracao where id_aluno=:id and ano_lectivo=:an order by id_pagamento_declaracao desc";
...
if($conv2==0)
{
  echo("nenhuma declaração encontrada para este ano!");
}
else
{
...
<div class="meses_pagos">
	...
	<option value="<?php echo $rt->id_pagamento_declaracao;?>"><?php echo $rt->tipo."=> ".$rt->data_pagamento;?></option><?php }}?>
</select>
</div>
<br />
<br />
