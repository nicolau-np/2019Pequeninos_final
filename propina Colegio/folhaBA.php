...
<head>
    ...
    <title>Balanço de Folha de Prova</title>
	...
	?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Balanço de Folha de Prova</h1>
                        </div>
                </div>
                <div class="row">
                <div class="col-md-12">
              ...
              <div class="panel-body">
                  <form role="form" method="POST" action="folhaBA.php">
              ...
              if(isset($_POST['bt1'])){
                  ...
                  //pagamentos normais
                  echo '<br/><br/>';
$co="SELECT SUM(valor_pago) FROM view_pagamento_folhas where ano_lectivo=:ano and tipo_prova=:p";
$exe=$con2->prepare($co);
...
//femenino
$genero1="Femenino";
$co="SELECT SUM(valor_pago) FROM view_pagamento_folhas where ano_lectivo=:ano and genero=:genero and tipo_prova=:p";
$exe=$con2->prepare($co);
$exe->bindParam(":ano",$ano,PDO::PARAM_STR);
