    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
			...
			?>
                ...
                <h5>Marcação de Faltas Professores</h5>
                <h1><?php echo $dias;?>-Feira</h1>
            </div>
        </div><!--pageheader-->
...
$in="insert into tbl_falta_prof (id_professor,data,hora,tipo_falta,semana,ano,mes,dia)values(:id_professor,:data,:hora,:tipo,:semana,:ano,:mes,:dia)";
$ex61=$con->prepare($in);
$ex61->bindParam(":id_professor",$ids,PDO::PARAM_STR);
$ex61->bindParam(":data",$data,PDO::PARAM_STR);
$ex61->bindParam(":hora",$hora,PDO::PARAM_STR);
$ex61->bindParam(":tipo",$tipo,PDO::PARAM_STR);
$ex61->bindParam(":semana",$dias,PDO::PARAM_STR);
$ex61->bindParam(":ano",$ano60,PDO::PARAM_STR);
$ex61->bindParam(":mes",$mes,PDO::PARAM_STR);
$ex61->bindParam(":dia",$dia,PDO::PARAM_STR);
$ex61->execute();

}
if($ex61)
{
echo "<div class='alert alert-success'>$a Professor(s) marcado(s) falta de $tipo";
}
}					
...
?>
                    ...
                    <form action="m_faltas_professor.php" method="POST" class="" name="f1">
				  ...
				  <tbody>
				  <?php 
				  $s60="select distinct nome_prof ,id_professor from view_horario where semana=:s  order by nome_prof asc";
				  $ex60=$con->prepare($s60);
				  $ex60->bindParam(":s",$dias,PDO::PARAM_STR);
				  $ex60->execute();
				  $a=0;
				  while($v60=$ex60->fetch(PDO::FETCH_OBJ)){
				  $a++;
                                  $sql25="select *from view_horario where id_professor=:id and semana=:s";
                                  $run25=$con->prepare($sql25);
                                  $run25->bindParam(":id",$v60->id_professor,PDO::PARAM_STR);
                                  $run25->bindParam(":s",$dias,PDO::PARAM_STR);
                                  $run25->execute();
                                  $count25=$run25->rowCount();
				  ?>
				  <tr>
				  <td>
				  <input type="checkbox" name="id[]" value="<?php echo $v60->id_professor;?>"/> <?php echo $v60->id_professor;?>
				  
				  </td>
				   <td><?php echo $a;?></td>
				    
					 <td><?php echo $v60->nome_prof;?></td>
