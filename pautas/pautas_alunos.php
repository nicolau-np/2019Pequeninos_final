...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="pautas_alunos.php">Pautas</a> <span class="separator"></span></li>
        ...
        <div class="pageheader">
            ...
            <div class="pageicon"><span class="iconfa-chevron-down"></span></div>
            <div class="pagetitle">
                <h5>Estudantes</h5>
                <h1>Pautas</h1>
            </div>            
                    ...
                    <div class="span10">
                        <form method="GET" action="pautas_alunos.php">
                            <div class="form-inline">
                                ...
                                ?>
                                          <option value="<?php echo $ver1->curso;?>"><?php echo $ver1->curso;?></option>
             <?php  }?>
                                    </select></span>
                                <label>Classe:</label>
             ...
             <?php  }?>
                   ...
                   <?php  }?>
                             ...
                             <?php  }?>
                                ...
                                <label>Ano:</label>
                                <span class="field">
                                    <input type="text" name="anolect" value="<?php echo date("Y");?>" placeholder="Ano" required="" style="width: 50px;"/>
                                </span>
                                
                              
                            <input name="btpes" value="Visualisar" type="submit" class="btn btn-primary"/>
        ...
        if(($_GET['curso']=="Geral")&&(($_GET['classe']=="Iniciação")||($_GET['classe']=="1ª")||($_GET['classe']=="3ª")||($_GET['classe']=="5ª"))):
          include("pautas_finais/ini_5.php");
	else:
            include("pautas_finais/2_9.php");
          endif;
