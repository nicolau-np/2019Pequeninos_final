                ...
                <div class="row">
                    <div class="span10">
                        ...
                        <div class="av">
                          ...
                          if($v71->estado=="ON"): echo"<br/><a href='eliminar_prova.php?id_prova=".$view80->id_prova."&&id_aluno=".$view80->id_aluno."&&id_disciplina=".$id_dis."&&ano=".$ano800."&&epoca=".$epoca."&&curso=".$ver->curso."&&classe=".$ver->classe."&&pagina=lanca2_4.php'>eliminar</a>";
                          endif;
                          echo '</span></td>';
...
include_once 'classes/LancPROVA.php';
                                   ...
                                   if($result1 == "yes"):
                                      ...
                                      // $ObjectCalculos->setCon($con);
                                       ...
                                       if($result3 == "yes"):
                                           ...
                                           $ObjectConversao->setComprensao($CF);
                                           $CF_EXTENSO = $ObjectConversao->Converte();
                                           $OBSERVACAO = $ObjectClassDisciplinas->retornaCla2_4($CF);
                                           /**update em cap e cf e observacao*/
                                           $result4 = $ObjectLancFINAIS->updateFinal($CAP, round($CF), $OBSERVACAO, $CF_EXTENSO, $id_aluno, $id_dis, $ano800);
                                           if($result4 == "yes"):
                                               echo '<div class = "alert alert-success">Lançamento feito com sucesso!</div>';
    ...
    ?>
                            ...
                            <form class="" name="g" method="POST" action="lanca2_4.php">
...
?>
                        <div class="glo">
                            <form class="" name="go" method="POST" action="lanca2_4.php">
                                ...
                                <div class="form-inline">
                                    ...
                                    <input type="submit" value="Salvar" class="btn btn-primary" name="sav2">
                            </form>
                        </div>
                    </div>
