...
<title>Directores de Turma</title>
...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
       ...
       <h4 class="widgettitle">Directores de Turma</h4>
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <thead>
                        <tr>
                           ...
                           <th class="head0">Ano Lectivo</th>
                        </tr>
                    </thead>
                    <tbody>
                      <?php 
                   
                    $se="select *from view_director order by anolectivo desc";
                    $x=$con->prepare($se);
                    $x->execute();
                        ...
                        <tr class="gradeX">
                          <td class="aligncenter"><span class="center">
                           ...
                           <td><?php echo $vr->nAgente;?></td>
                            ...
                            <td><?php echo $vr->curso;?></td>
                            <td><?php echo $vr->classe;?></td>
                            <td><?php echo $vr->turma;?></td>
                            <td><?php echo $vr->turno;?></td>
                            <td><?php echo $vr->anolectivo;?></td>
