...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#txt_pesqui").keyup(function(e){
            var nome = $("#txt_pesqui").val();
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle">Estudantes cadastrados</h4>
                <div class="exibe2">
                    <br/>
                    &nbsp;<input type="text" id="txt_pesqui" placeholder="Pesquiza pelo nome"/>
                    <div class="tabV">
                <table id="tableM" class="table table-bordered responsive">
                    ...
                    <tbody>
                    <?php 
                    $select="select *from view_estudante limit 10";
