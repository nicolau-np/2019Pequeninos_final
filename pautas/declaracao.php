    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle">Declaração</h4>
				<?php 
...
$mostra6001=$exe6001->fetch(PDO::FETCH_OBJ);
    ...
    <form class="stdform" action="declaracao.php" method="post" enctype="multipart/form-data">
	<p>
	<label style="color:green; font-size:14px; font-weight:bold;"><?php echo $mostra6001->nome;?></label>
	</p><br/>
	<p>
                                <label>Nº:</label>
                             <span class="field"><input type="text" name="numero" class="input-large" placeholder="001" required="yes"/></span>
                            </p>
	
	<p>
                                <label>Tipo:</label>
                                <span class="field"><select name="tipo" id="selection1" class="input-medium">
                                          <option>Sem Notas</option>
										<option>Com Notas</option>
                                </select></span>
                            </p>
	  ...
	  <p>
                            <label>Efeito:</label>
                            <span class="field"><input type="text" name="efeito" class="input-large" placeholder="Estudo" required="yes"/></span>
                        </p>
						
						 <p>
                            <label>Ano Lectivo:</label>
                            <span class="field"><input type="text" name="ano" class="input-large" placeholder="2018" required="yes"/></span>
                        </p>
						<p>
						<input type="submit" value="Avançar" name="ava" class="btn btn-primary"/>
						</p>
	...
	echo"
	<script>
	window.location.href='declaracao_aluno.php?efeito=$efeito&&ano=$ano&&numero=$numero';
	</script>
	
	";
	else:
	
	if(($classe=="1ª")||($classe=="3ª")||($classe=="5ª")||($classe=="Iniciação")){
	echo"
	<script>
	window.location.href='declaracao_nota/ini_5.php?efeito=$efeito&&ano=$ano&&numero=$numero&&classe=$classe';
	</script>
	...
	";
          ...
          echo"
	<script>
	window.location.href='declaracao_nota/2_9.php?efeito=$efeito&&ano=$ano&&numero=$numero&&classe=$classe';
	</script>
