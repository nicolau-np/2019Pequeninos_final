...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <?php
            include("classes/salvar_usuario2.php");
            if(isset($_POST['bt1']))
            {
                $nome=$_POST['nome'];
                ...
                $obj=new salvar_usuario;
             
                   /*
                    $obj->cadastro($nome,$palavra1,$palavra2,$estado,$titulo,$arquivo,$arquivo_tmp,$con);
            */
           $resp1=$obj->receber_valores($con,$titulo);
           $resp2=$obj->verifica_senha($resp1, $palavra1, $palavra2);
           $resp3=$obj->verifica_pessoa($resp2, $arquivo,$nome);
           $resp4=$obj->salvar_pessoa($resp3,$nome,$arquivo,$arquivo_tmp,$bi);
           $resp5=$obj->buscar_IDpessoa($resp4,$nome,$estado);
           $resp6=$obj->buscar_IDusuario($resp5);
           $obj->salvar_senha($resp6, $palavra1);
            }
            ?>
                <form class="stdform" action="table-static.php" method="post" enctype="multipart/form-data">
                        ...
                        <p>
                         ...
                         <p>
                            ...
                            <span class="field"><input type="text" name="palavra1" class="input-medium" placeholder="1234namibe" required="yes"/></span>
                        </p>
                        <p>
                            <label>Confirmar Passe:</label>
                            <span class="field"><input type="text" name="palavra2" class="input-medium" placeholder="1234namibe" required="yes"/></span>
                        </p>
