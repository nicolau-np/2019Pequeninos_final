...
echo $dias."-Feira";				
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class='active'><a href="<?php if(($contar000>0)&&($_SESSION['tituloMRX']=="Professor Director")):echo'pauta_faltas.php?curso='.$ver000->curso.'&&classe='.$ver000->classe.'&&turma='.$ver000->turma.'&&turno='.$ver000->turno.''; else: echo'#'; endif;?>">Faltas</a></li>
                </ul>
                </li>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
		  ...
		  include("paut_faltas/pt_fault.php");
