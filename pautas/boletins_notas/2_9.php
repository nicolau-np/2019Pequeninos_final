...
$ver1=$re1->fetch(PDO::FETCH_OBJ);
                                ?>
                            <td class="<?php if(($classe=="2ª")||($classe=="4ª")): if($ver1->ct>=5): echo "azul"; else: echo"vermelho"; endif; else: if($ver1->ct>=10): echo "azul"; else: echo"vermelho"; endif; endif;?>"><?php echo $ver1->ct;?></td>
                              <?php }?> 
                    </tr>
                    </tbody>
                    </table>
