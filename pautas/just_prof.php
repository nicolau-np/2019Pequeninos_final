                       ...
                       ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo $ver->data;?></td>
                                <td><?php echo $ver->hora;?></td>
                                <td><?php echo $ver->semana;?></td>
                                <td><a href="elimina_falta.php?id_falta=<?php echo $ver->id_falta_prof;?>" class="btn btn-success" >Justificar</a></td>
                            </tr>
                            <?php }?>
                        </table>
