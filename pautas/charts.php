...
echo $dias."-Feira";				
                ...
                <li class="dropdown" id="Admin1"><a href=""><span class="iconfa-th-list"></span> Usuários</a>
                 ...
                 <li class="dropdown active" id="usuarioAdmin2"><a href=""><span class="iconfa-calendar"></span> Professores</a>
                	<ul style="display: block;">
                    	<li class="active"><a href="chartsBackup.php">Novo</a></li>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="chartsBackup.php">Professores</a> <span class="separator"></span></li>
            <li>Novo</li>
        ...
        <div class="maincontent">
            ...
            if(isset($_POST['bt1']))
            {
                ...
                include("classes/salvar_professor.php");
              $nome=$_POST['nome'];
              $agente=$_POST['agente'];
              ...
              $obj= new salvar_professor;
              if($titulo=="Professor Normal"):
                                 

                $resNAGen = $obj-> selectProfessor($agente,$con);
                $resPess = $obj-> salvarPessoa($con,$resNAGen,$nome,$agente,$data,$telefone,$bi,$data_emissao,$local_emissao,$genero,$titulo,$arquivo,$arquivo_tmp,$pai,$mae,$provincia,$municipio,$categoria_estudo);
                $obj-> consultaPessoa($con,$resPess,$nome,$data,$resPess);
                $resProf = $obj-> salvarProfessor($con,$agente,$titulo,$categoria_estudo,$resPess);
                $resU = $obj-> salvarUSUARIO($con,$titulo,$resProf);
                $obj-> consultaUsuario($con,$resU);
                $obj-> salvarSenhas($con,$telefone,$resU);  
              else:
                  ...
                  if($conta1>0):
                    ...
                    $resNAGen = $obj-> selectProfessor($agente,$con);
                    $resPess = $obj-> salvarPessoa($con,$resNAGen,$nome,$agente,$data,$telefone,$bi,$data_emissao,$local_emissao,$genero,$titulo,$arquivo,$arquivo_tmp,$pai,$mae,$provincia,$municipio,$categoria_estudo);
                    $obj-> consultaPessoa($con,$resPess,$nome,$data);
                    $resProf = $obj-> salvarProfessor($con,$agente,$titulo,$categoria_estudo,$resPess);
                    $resU = $obj-> salvarUSUARIO($con,$titulo,$resProf);
                    $obj-> consultaUsuario($con,$resU);
                    $resSenha = $obj-> salvarSenhas($con,$telefone,$resU);  
                    $obj -> selectProfessorID($con);
                    //if($resSenha ==0){
                        $obj -> salvarDirector($curso,$classe,$turma,$turno,$ano,$con);
                   // }
                  endif;
            ...
            ?>
                <form class="stdform" action="charts.php" method="post" enctype="multipart/form-data">
                    	
                        <p>
                            <label>Nome de Completo:</label>
                            <span class="field"><input type="text" name="nome" class="input-xlarge" placeholder="João Manuel" required="yes"/></span>
                        </p>
                        
                         <p>
                            <label>Nº Agente:</label>
                            <span class="field"><input type="text" name="agente" class="input-medium" placeholder="1234" required="yes"/></span>
                        </p>
                        <p>
                            <label>Data de Nascimento:</label>
                            <span class="field"><input type="date" name="nascimento" class="input-medium"  required="yes"/></span>
                        </p>
...
<option value="Cabinda">Cabinda</option>
	...
	<option>Selecione...</option>
                        ...
                        <p>
                            ...
                            <span class="field"><input type="text" name="pai" class="input-medium"  placeholder="Jose"/></span>
                        </p> 
                        ...
                        <p>
                            ...
                            <span class="field"><input type="text" name="telefone" class="input-medium" placeholder="946216795" required=""/></span>
                        </p>
                        <p>
                            <label>Nº B.I.:</label>
                            <span class="field"><input type="text" name="bi" class="input-medium" placeholder="34678722NE046" required="yes"/></span>
                        </p>
                        <p>
                        ...
                        <p>
							...
							<p class="aas">
                                <label>Curso:</label>
                                <span class="field"><select name="curso" id="selection69" class="input-medium">
                                <?php 
                   ...
                   <?php  }?>
                    ...
                    <p class="aas">
                     <label>Ano Lectivo:</label>
                            <span class="field"><input type="text" class="input-medium" value="<?php echo date('Y');?>" required="yes" name="ano1"/></span>
                    </p>
