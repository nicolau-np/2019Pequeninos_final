               ...
               <li id="director1" class="dropdown"><a href=""><span class="iconfa-hand-up"></span> Pautas :: <?php if(($contar000>0)&&($_SESSION['tituloMRX']=="Professor Director")): echo $ver000->classe."".$ver000->turma." ".$ver000->turno; endif;?></a>
                ...
                <li class="dropdown active" id="Admin1"><a href=""><span class="iconfa-th-list"></span> Usuários</a>
                	<ul style="display: block;">
                        ...
                        <li class="active"><a href="table-dynamic.php">Visualizar</a></li>
                    </ul>
                </li>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle">Usuários Cadastrados</h4>
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0">Nome de Usuário</th>
                    ...
                    <tbody>
                    <?php 
                    $titulo="Usuário Normal";
                      $titulo1="Usuário Normal 2";
                    $se="select *from view_usuario where titulo=:titulo or titulo=:titulo1";
                    $x=$con->prepare($se);
                    $x->bindParam(":titulo",$titulo,PDO::PARAM_STR);
                    $x->bindParam(":titulo1",$titulo1,PDO::PARAM_STR);
                    $x->execute();
                    while($vr=$x->fetch(PDO::FETCH_OBJ))
                    {
                        ...
                        <tr class="gradeX">
                          ...
                          <td style="width:200px;"><img width="200px" height="30px" src="fotos_usuarios/<?php echo $vr->foto;?>"/></td>
                           <td><?php echo $vr->nome;?></td>
                            <td><?php echo $vr->estado;?></td>
                            <td><a href="edita_usuario.php?id_pessoa=<?php echo $vr->id_pessoa;?>&&id_user=<?php echo $vr->id_user;?>&&foto=<?php echo $vr->foto;?>" class="btn btn-primary">Editar</a></td>
                            <td><a href="eliminar_usuario.php?id_pessoa=<?php echo $vr->id_pessoa;?>&&id_user=<?php echo $vr->id_user;?>&&foto=<?php echo $vr->foto;?>" class="btn btn-danger" style="color: #FFF;">Eliminar</a></td>
                        </tr>
                        <?php }?>
