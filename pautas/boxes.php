...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="boxes.php">Configurações</a> <span class="separator"></span></li>
            <li>Turmas</li>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                <div class="row">
                    <div class="span10">
                        <form name="fr" method="POST" action="boxes.php">
...
<?php }?>
             ...
             <?php  }?>
                   ...
                   <?php  }?>
                            ...
                            <span class="field"><input type="text" class="input-small" value="<?php echo date('Y');?>" required="yes" name="ano1"/></span>
                        
                             <button type="submit" class="btn btn-primary" name="bt1">Pesquisar</button>
                            </div>
                        </form>
                        <hr/>
                        <div id="mos">
                            ...
                            $ano=$_POST['ano1'];
                            $exibe="sim";
                            $sql="select *from view_horario where id_curso=:id_curso and id_classe=:id_classe and id_turma=:id_turma and id_turno=:id_turno and anolectivo=:ano and exibe=:exibe";
                            $run=$con->prepare($sql);
                            $run->bindParam(":id_curso",$id_curso,PDO::PARAM_STR);
                              $run->bindParam(":id_classe",$id_classe,PDO::PARAM_STR);
                                $run->bindParam(":id_turma",$id_turma,PDO::PARAM_STR);
                                  $run->bindParam(":id_turno",$id_turno,PDO::PARAM_STR);
                                    $run->bindParam(":ano",$ano,PDO::PARAM_STR);
                                    $run->bindParam(":exibe",$exibe,PDO::PARAM_STR);
                            $run->execute();
                            while($view=$run->fetch(PDO::FETCH_OBJ)){
                              echo'<tr>
                                <td>'.$view->nome_prof.'</td>
                                <td>'.$view->nome.'</td>
                                <td>'.$view->curso.'</td>
                                <td>'.$view->classe.'</td>
                                    <td>'.$view->turma.'</td>
                        ...
                        <form name="fr" method="POST" action="boxes.php">
                            <div class="form-inline">
                                <label>Curso:</label>
						<span class="field"><select name="curso2" id="selection1" class="input-medium">
                                                   <option><?php if(isset($_POST['curso2'])): echo $_POST['curso2']; else: echo 'Selecione...'; endif;?></option>
                                                    <?php 
$t="select *from tbl_curso";
$a=$con->prepare($t);
$a->execute();
...
{
?>
<option><?php echo $ver->curso;?></option>
<?php }?>
</select></span>
			
                                <label>Classe:</label>
                                <span class="field"><select name="classe2" id="selection1" class="input-medium">
                                        <option><?php if(isset($_POST['classe2'])): echo $_POST['classe2']; else: echo 'Selecione...'; endif;?></option>
                                    <?php 
                                $sel1="select *from tbl_classe";
                                $ex1=$con->prepare($sel1);
                                $ex1->execute();
             ...
             <?php  }?>
                             ...
                             <button type="submit" class="btn btn-primary" name="bt2">Pesquisar</button>
                            </div>
                        </form>
                                 <div id="mos2">
                            <table class="table table-bordered">
                            ...
                            $sql2="select *from view_disciplinas where curso=:id_curso and classe=:id_classe";
                            $run2=$con->prepare($sql2);
                            $run2->bindParam(":id_curso",$curso,PDO::PARAM_STR);
                            $run2->bindParam(":id_classe",$classe,PDO::PARAM_STR);
                              
                            $run2->execute();
                            while($view2=$run2->fetch(PDO::FETCH_OBJ)){
                              echo'<tr>
                                <td>'.$view2->nome.'</td>
                                <td>'.$view2->curso.'</td>
                                <td>'.$view2->classe.'</td>
                                <td><a href="elimina_dis.php?id_disciplina='.$view2->id_disciplina.'">Eliminar</a></td>
