...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pageicon"><span class="iconfa-briefcase"></span></div>
             <?php 
                        if(addslashes(htmlspecialchars(isset($_GET['id_aluno'])))){
                         $id_aluno=addslashes(htmlspecialchars($_GET['id_aluno']));
                        $id_dis=addslashes(htmlspecialchars($_GET['id_dis']));
                        $epoca=addslashes(htmlspecialchars($_GET['epoca']));
                        $ano800=addslashes(htmlspecialchars($_GET['ano']));
                       
                         $_SESSION['id_aluno']=addslashes(htmlspecialchars($_GET['id_aluno']));
                         $_SESSION['id_dis']=addslashes(htmlspecialchars($_GET['id_dis']));
                         $_SESSION['epoca']=addslashes(htmlspecialchars($_GET['epoca']));
                         $_SESSION['ano']=addslashes(htmlspecialchars($_GET['ano']));   
                        }
                        else
                        {
    ...
    <?php 
                           ...
                           ?>
                            ...
                            <form class="" name="g" method="POST" action="lanca6_9.php" >
    ...
    ?>
                        <div class="glo">
                            <form class="" name="go" method="POST" action="lanca6_9.php">
                                <fieldset>
