    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1><?php 
				if(isset($_GET['curso'])):
				$_SESSION['classevb']=$_GET['classe'];
				$_SESSION['turmavb']=$_GET['turma'];
				$_SESSION['turnovb']=$_GET['turno'];
				$_SESSION['anovb']=$_GET['ano'];
				echo $_GET['classe']." ".$_GET['turma']." ".$_GET['turno']." ".$_GET['ano'];
				else:
				echo $_SESSION['classevb']." ".$_SESSION['turmavb']." ".$_SESSION['turnovb']." ".$_SESSION['anovb'];
				endif;
				?></h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                <div class="row-fluid">
					...
					<?php 
					$r5590="select *from view_estudante where anolectivo=:ano and classe=:classe and turma=:turma and turno=:turno order by nome asc";
					$e5590=$con->prepare($r5590);
					$e5590->bindParam(":ano",$_SESSION['anovb'],PDO::PARAM_STR);
					$e5590->bindParam(":classe",$_SESSION['classevb'],PDO::PARAM_STR);
					$e5590->bindParam(":turma",$_SESSION['turmavb'],PDO::PARAM_STR);
					$e5590->bindParam(":turno",$_SESSION['turnovb'],PDO::PARAM_STR);
					$e5590->execute();
					?>
					 ...
					 <th>Criar Termo</th>
					  ...
					  <?php
					  $a=0;
while($v5590=$e5590->fetch(PDO::FETCH_OBJ)){	
$a++;				  
					  ?>
					  <tr>
					  <td><?php echo $a;?></td>
					  <td><?php echo $v5590->nome;?></td>
					   <td><?php echo $v5590->genero;?></td>
					    <td><?php if($v5590->cardeneta=="sim"): echo"Criada"; else: echo "<a href='cria5590.php?id_aluno=".$v5590->id_aluno."&&processo=".$v5590->processo."&&classe=".$v5590->classe."&&turma=".$v5590->turma."&&turno=".$v5590->turno."&&ano=".$_SESSION['anovb']."&&curso=".$v5590->curso."'>Criar</a>";endif;?></td>
					  </tr>
					  <?php }?>
					  </tbody>
</table>                                                
