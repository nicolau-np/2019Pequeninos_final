...
//empreendedorismo
$co14="select *from view_clas_finais where disciplina=:disciplina and anolectivo=:ano and id_aluno=:id";
$re14=$con->prepare($co14);
$re14->bindParam(":disciplina",$disciplina14,PDO::PARAM_STR);
