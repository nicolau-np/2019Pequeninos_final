...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <?php 
            include("classes/confir_matricula2.php");
            ...
            if(isset($_POST['bt1']))
            {
               ...
               $municipio=$_POST['municipio'];
                $ano_antigo=$_POST['ano2'];
                $processo=$_POST['processo_antigo'];
               $titulo="aluno";
              $quota = $_POST['quota'];
               
               
               $obj= new confirm_matricula;
               
          
               $resp1=$obj->recebe_valores($id_alunoAluno, $id_pessoaAluno, $fotoAluno, $titulo);
               $resp2=$obj->verifica_ano($resp1,$ano,$ano_antigo,$arquivo,$arquivo_tmp);
               $resp3=$obj->edita_pessoa($resp2,$con,$nome,$genero,$data,$bi,$emissao,$local_emissao,$telefone,$titulo,$pai,$mae,$provincia,$municipio);
              
               $resp5=$obj->editar_aluno($resp3, $con, $curso, $classe, $turma, $turno, $ano);
               $resp6=$obj->edita_historico($resp5, $con, $curso, $classe, $turma, $turno, $ano);
               $obj->salvar_meses($resp6, $con, $ano);
               ...
               $objComp = new Comp_pais();
                ...
                <form class="stdform" action="confirm_Matricula.php" method="post" enctype="multipart/form-data">
                        ...
                        <p>
                         ...
                         <p>
                            <label>Nº Proc.:</label>
                            <span class="field">
                                <input type="hidden" name="processo_antigo" class="input-medium" placeholder="1234" required="yes" value="<?php echo $ver_AlunoE->id_aluno;?>"/>
                                <input type="text" name="processo" class="input-medium" placeholder="1234" required="yes" value="<?php echo $ver_AlunoE->id_aluno;?>" disabled="disabled"/></span>
                        </p>
...
<option value="Cabinda">Cabinda</option>
	...
	<option><?php echo $ver_AlunoE->municipio;?></option>
                        ...
                        <p>
                                <label>Genero:</label>
                                <span class="field"><select name="genero" id="selection1" class="input-medium">
                            ...
                            <span class="field"><input type="text" name="pai" class="input-medium"  placeholder="Jose" value="<?php echo $ver_AlunoE->pai;?>" required=""/>
                             <input type="hidden" name="pai_antigo" value="<?php echo $ver_AlunoE->pai;?>"/>
                            </span>
                        </p> 
    ...
    ?>
				...
				<a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
                        ...
                        <p>
                            ...
                            <span class="field">
                                <input type="hidden" class="input-medium" value="<?php echo $ver_AlunoE->anolectivo;?>" required="yes" name="ano2"/>
                                <input type="text" class="input-medium" placeholder="Ano Lectivo" required="yes" name="ano1"/></span>
                        </p>
