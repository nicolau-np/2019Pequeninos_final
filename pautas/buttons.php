...
echo $dias."-Feira";				
    ...
    <div class="leftpanel">
         ...
         <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li id="director1" class="dropdown active"><a href=""><span class="iconfa-hand-up"></span> Pautas :: <?php if(($contar000>0)&&($_SESSION['tituloMRX']=="Professor Director")): echo $ver000->classe."".$ver000->turma." ".$ver000->turno; endif;?></a>
                	<ul style="display: block;">
                <li class="active"><a href="<?php if(($contar000>0)&&($_SESSION['tituloMRX']=="Professor Director")):echo'buttons.php?curso='.$ver000->curso.'&&classe='.$ver000->classe.'&&turma='.$ver000->turma.'&&turno='.$ver000->turno.''; else: echo'#'; endif;?>"></span> Notas</a></li>
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                <h5>Pautas</h5>
                <h1><?php echo $_GET['curso']." - ".$_GET['classe']." ".$_GET['turma']." ".$_GET['turno'];?></h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
          ...
          <?php 
          if(($_GET['curso']=="Geral")&&(($_GET['classe']=="Iniciação")||($_GET['classe']=="1ª")||($_GET['classe']=="3ª")||($_GET['classe']=="5ª"))):
          include("pautas_finais/ini_5T.php");
	else:
            include("pautas_finais/2_9T.php");
          endif; 
          ?>
