...
<title>Historico do Estudante</title>
...
if(addslashes(htmlspecialchars(isset($_GET['id_aluno'])))):
  $_SESSION['id_alunoV3']=  addslashes(htmlspecialchars($_GET['id_aluno']));  
  $id_alunoV3 = addslashes(htmlspecialchars($_GET['id_aluno']));
  else:
      $id_alunoV3 = $_SESSION['id_alunoV3'];
endif;            
            ?>
                <h4 class="widgettitle">Histórico Acadêmico</h4>
                <div class="exibe2">
                    <br/>
                ...
                <table id="tableM" class="table table-bordered responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1">Ano Lectivo</th>
                            <th class="head0">Nº Proc.</th>
                            <th class="head1">Nome Completo</th>
                            <th class="head0">Curso</th>
                            <th class="head1">Classe</th>
                            <th class="head0">Turma</th>
                            <th class="head1">Turno</th>
                            <th class="head1">Aproveitamento</th>
                            <th class="head0">Termo</th>
                 </tr>
                    </thead>
                    <tbody>
                    <?php 
                    $select="select *from view_historico where id_aluno=:id";
        $xe=$con->prepare($select);
        $xe->bindParam(":id", $id_alunoV3, PDO::PARAM_STR);
        $xe->execute();
                    while($ver=$xe->fetch(PDO::FETCH_OBJ))
                    {
                        ...
                        <tr class="gradeX">
                          ...
                          <td><?php echo $ver->id_aluno;?></td>
                            ...
                            <td><?php if($ver->aproveitamento==""): echo "---"; else:echo $ver->aproveitamento; endif;?></td>
                            <td><?php if(($ver->classe=="Iniciação")||($ver->classe=="1ª")||($ver->classe=="2ª")||($ver->classe=="3ª")||($ver->classe=="4ª")||($ver->classe=="5ª")): echo '---'; else: echo '<a href="Termos/verTermo2_9.php?id_aluno='.$ver->id_aluno.'&&ano_lectivo='.$ver->anolectivo.'" class="btn btn-warning btn-xs">+ termo</a>'; endif;?></td>
