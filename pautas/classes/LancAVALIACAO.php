...
public function inserirAVALIACAO($id_aluno, $id_disciplina, $epoca, $ano, $data, $valor){
     $this->resposta = null;
     $this->sql = "insert into tbl_avaliacao (id_aluno, id_disciplina, epoca, ano, valor, data)"
