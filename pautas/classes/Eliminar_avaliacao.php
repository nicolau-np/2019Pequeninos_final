...
class Eliminar_avaliacao {
    ...
    public function __construct($con,$ano,$id_aluno,$id_avaliacao,$id_disciplina,$epoca,$curso,$classe,$pagina) {
        $this->CON=$con;
        $this->ANO=$ano;
        ...
        public function eliminar_ava() {
          $sql1="delete from tbl_avaliacao where id_ava=:id_avaliacao and id_aluno=:id_aluno and ano=:ano and epoca=:epoca and id_disciplina=:id_disciplina";
          try {
              $run1=  $this->CON->prepare($sql1);
              $run1->bindParam(":id_avaliacao",  $this->ID_AVALIACAO,PDO::PARAM_STR);
            ...
            if($r1==0):
                ...
                elseif($r1==1) :
                   ...
                   $run5->execute();
                        ...
                        $sql4="update tbl_notas set mac=:mac, ct=:ct where anoLetivo=:ano and id_aluno=:id_aluno and id_di2=:id_dis and epoca=:epoca";
                        $run4=  $this->CON->prepare($sql4);
                        $run4->bindParam(":mac",  $MAC,  PDO::PARAM_STR);
