...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
       ...
       <h4 class="widgettitle">Professores Cadastrados</h4>
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0">Gênero</th>
                            <th class="head1">Título</th>
                            <th class="head0">Editar</th>
                            <th class="head1">Horário</th>
                            <th class="head0">Guia Médica</th>
                            <th class="head1">Eliminar</th>
                        </tr>
                    </thead>
                    <tbody>
                      <?php 
                   
                    $se="select *from view_professor";
                    $x=$con->prepare($se);
                    $x->execute();
                    while($vr=$x->fetch(PDO::FETCH_OBJ))
                    {
                        ...
                        <tr class="gradeX">
                          ...
                          <td><img width="200px" height="30px" src="fotos_professores/<?php echo $vr->foto;?>"/></td>
                           <td><?php echo $vr->nAgente;?></td>
                            <td><?php echo $vr->nome;?></td>
                            <td><?php echo $vr->genero;?></td>
                            <td><?php echo $vr->titulo;?></td>
                           <td><a href="edita_professor.php?id_pessoa=<?php echo $vr->id_pessoa;?>&&id_user=<?php echo $vr->id_professor;?>&&foto=<?php echo $vr->foto;?>" class="btn btn-primary" style="color: #fff;">Editar</a></td>
                           <td><a href="cria_horario.php?id_pessoa=<?php echo $vr->id_pessoa;?>&&id_user=<?php echo $vr->id_professor;?>&&foto=<?php echo $vr->foto;?>" class="btn btn-success" style="color: #fff;">Horário</a></td>
                           <td><a href="guia_medica.php?id_pessoa=<?php echo $vr->id_pessoa;?>&&id_user=<?php echo $vr->id_professor;?>&&foto=<?php echo $vr->foto;?>" class="btn btn-default" style="color: #333;">Guia Médica</a></td>
                            <td><a href="elimina_professor.php?id_pessoa=<?php echo $vr->id_pessoa;?>&&id_user=<?php echo $vr->id_professor;?>&&foto=<?php echo $vr->foto;?>&&titulo=<?php echo $vr->titulo;?>" class="btn btn-danger" style="color: #fff;">Eliminar</a></td>
                        </tr>
          <?php }?>
                    </tbody>
                </table>
