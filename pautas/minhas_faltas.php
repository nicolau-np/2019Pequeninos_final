...
echo $dias."-Feira";				
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pageicon"><span class="iconfa-building"></span></div>
            <div class="pagetitle">
                <h5>Consulta Faltas</h5>
                <h1>Professores</h1>
            </div>            
        </div><!--pageheader-->
            ...
            <div class="maincontentinner">
              ...
              <div class="span10">
                         ...
                         $estado1="ativo";
                                ...
                                $sql26="select *from tbl_professor where id_pessoa=:id";
                        $run26=$con->prepare($sql26);
                        $run26->bindParam(":id",$_SESSION['id_pessoaMRX'],PDO::PARAM_STR);
                         $run26->execute();
                         $view26=$run26->fetch(PDO::FETCH_OBJ);
                         
                         try {
                           $sql22="select *from view_faltas_prof where id_professor=:id and ano=:ano and estado=:estado";
                         $run22=$con->prepare($sql22);
                         $run22->bindParam(":id",$view26->id_professor,PDO::PARAM_STR);
                       ...
                       ?>
                        <div>
                            <?php
                            if(isset($_GET['jus'])){
                                 echo'<div class="alert alert-success">Justificada com sucesso!</div>';
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php 
                            while ($ver=$run22->fetch(PDO::FETCH_OBJ)){
                            ?>
                            <?php if($conta>0):
                                echo'<tr>
                                <td>'.$ver->nome.'</td>
