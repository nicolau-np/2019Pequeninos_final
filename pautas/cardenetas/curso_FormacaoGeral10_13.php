...
<div class="tabs-left">
				...
				$epoca3=3;
                 ...
                 $view_1=$ex->fetch(PDO::FETCH_OBJ);
                    ?>
                        ...
                        <td><?php if($view_epoca1->estado =="OFF" ): echo'bloqueado'; else: echo '<a href="lanca_CursoFormacaoGeral10_13.php?id_aluno='.$ver_epoca1->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca1.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
                 ...
                 $view_2=$ex2->fetch(PDO::FETCH_OBJ);
                    ?>
                       ...
                       <td><?php if($view_epoca2->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca_CursoFormacaoGeral10_13.php?id_aluno='.$ver_epoca2->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca2.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
                ...
                <tr>
                 <td><img src="foto_alunos/<?php echo $view_3->foto;?>" style="width:40px; height:40px;"  /></td>
                       ...
                       <td><?php if($view_epoca3->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca_CursoFormacaoGeral10_13.php?id_aluno='.$ver_epoca3->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca3.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
			...
			<th>Editar</th>
                ...
                <tr>
                   <td><img src="foto_alunos/<?php echo $view_4->foto;?>" style="width:40px; height:40px;"/></td>
                       ...
                       <td><?php if($view_epoca4->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca_CursoFormacaoGeral10_13.php?id_aluno='.$ver_epoca4->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca=4&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
