                    ...
                    ?>
                        ...
                        <tr>
                         <td><img src="foto_alunos/<?php echo $ver_epoca1->foto;?>" style="width:40px; height:40px;"  /></td>
                            ...
                            <td><?php if($view_epoca1->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca1_5.php?id_aluno='.$ver_epoca1->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca1.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
...
?>
             ...
             $a2++;
                    ?>
                        ...
                        <td><?php if($view_epoca2->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca1_5.php?id_aluno='.$ver_epoca2->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca2.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
                                </tr>
                        <?php  } ?>
                    </tbody>
                </table>
			...
			<th>Editar</th>
             ...
             $a3++;
                 ...
                 <tr>
                        ...
                        <td><?php if($view_epoca3->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca1_5.php?id_aluno='.$ver_epoca3->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca3.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
                 </tr>
                        <?php  } ?>
