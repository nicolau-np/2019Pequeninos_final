...
<div class="tabs-left">
                            <ul class="nav nav-tabs">
								...
								<li class="<?php if(isset($_POST['epoca4'])): echo "active"; elseif(!isset($_POST['epoca4'])): echo ""; endif;?>"><a data-toggle="tab" href="#lD">CPE</a></li>
                            </ul>
             ...
             $a1++;
                    ?>
                        ...
                        <td><?php if($view_epoca1->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca7_8.php?id_aluno='.$ver_epoca1->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca1.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
             ...
             $a2++;
                    ?>
                        ...
                        <td><img src="foto_alunos/<?php echo $ver_epoca2->foto;?>" style="width:40px; height:40px;"  /></td>
                         ...
                         <td><?php if($view_epoca2->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca7_8.php?id_aluno='.$ver_epoca2->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca2.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>           
                        </tr>
                        <?php  } ?>
                    </tbody>
                </table>
             ...
             $a3++;
                ...
                <tr>
                 <td><img src="foto_alunos/<?php echo $ver_epoca3->foto;?>" style="width:40px; height:40px;"  /></td>
                         ...
                         <td><?php if($view_epoca3->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca7_8.php?id_aluno='.$ver_epoca3->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca3.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
                        </tr>
                        <?php  } ?>
             ...
             $a4++;
                ...
                <tr>
                   <td><img src="foto_alunos/<?php echo $ver_epoca4->foto;?>" style="width:40px; height:40px;"/></td>
                         ...
                         <td><?php if($view_epoca4->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca7_8.php?id_aluno='.$ver_epoca4->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca=4&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
                        </tr>
                        <?php  } ?>
