...
<div class="tabs-left">
			 ...
			 <td><?php if($view_epoca1->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca2_4.php?id_aluno='.$ver_epoca1->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca1.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
             ...
             $a2++;
                    ?>
                       ...
                       <td><?php if($view_epoca2->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca2_4.php?id_aluno='.$ver_epoca2->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca2.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
			 ...
			 <td><?php if($view_epoca3->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca2_4.php?id_aluno='.$ver_epoca3->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca='.$epoca3.'&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
             ...
             $a4++;
                ...
                <tr>
                       ...
                       <td><?php if($view_epoca4->estado=="OFF"): echo'bloqueado'; else: echo '<a href="lanca2_4.php?id_aluno='.$ver_epoca4->id_aluno.'&&id_dis='.$id_disciplina200.'&&epoca=4&&ano='.$anoLectivo.'" class="btn btn-success">Avaliar</a>';endif;?> </td>
